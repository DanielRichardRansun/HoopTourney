...
<div class="container">
    <form action="{{ route('matchResults.store', ['id_tournament' => $tournament->id, 'id_schedule' => $schedule->id]) }}" method="POST">
        ...
        <div class="score-container">
            <div class="section-title">Hasil Pertandingan per Kuarter</div>
            <div id="quarter-scores-container">
                <div class="quarter-input-group" data-quarter-number="1">
                    <div>
                        <label>Kuarter 1</label>
                        <div style="display: flex; align-items: center; gap: 5px;">
                            <input type="number" name="quarter_scores[1][team1_score]" class="form-control" required min="0" placeholder="{{ $team1->name }}">
                            <input type="number" name="quarter_scores[1][team2_score]" class="form-control" required min="0" placeholder="{{ $team2->name }}">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="player-quarter-stats">
                    ...
                    <div id="player-stats-{{ $player->id }}-container">
                        <div class="player-stats" style="display: flex; gap: 10px; align-items: center; text-align: center; flex-wrap: wrap;">
                            <label style="font-weight: normal;">Kuarter 1</label>
                            <div style="display: flex; flex-direction: column;">
                                <span>Point</span>
                                <input type="number" name="player_stats[{{ $player->id }}][1][point]" min="0">
                            </div>
                            <div style="display: flex; flex-direction: column;">
                                <span>FGM</span>
                                <input type="number" name="player_stats[{{ $player->id }}][1][fgm]" min="0">
                            </div>
                            <div style="display: flex; flex-direction: column;">
                                <span>FGA</span>
                                <input type="number" name="player_stats[{{ $player->id }}][1][fga]" min="0">
                            </div>
                            <div style="display: flex; flex-direction: column;">
                                <span>FTA</span>
                                <input type="number" name="player_stats[{{ $player->id }}][1][fta]" min="0">
                            </div>
                            <div style="display: flex; flex-direction: column;">
                                <span>FTM</span>
                                <input type="number" name="player_stats[{{ $player->id }}][1][ftm]" min="0">
                            </div>
                            <div style="display: flex; flex-direction: column;">
                                <span>ORB</span>
                                <input type="number" name="player_stats[{{ $player->id }}][1][orb]" min="0">
                            </div>
                            <div style="display: flex; flex-direction: column;">
                                <span>DRB</span>
                                <input type="number" name="player_stats[{{ $player->id }}][1][drb]" min="0">
                            </div>
                            <div style="display: flex; flex-direction: column;">
                                <span>STL</span>
                                <input type="number" name="player_stats[{{ $player->id }}][1][stl]" min="0">
                            </div>
                            <div style="display: flex; flex-direction: column;">
                                <span>AST</span>
                                <input type="number" name="player_stats[{{ $player->id }}][1][ast]" min="0">
                            </div>
                            <div style="display: flex; flex-direction: column;">
                                <span>BLK</span>
                                <input type="number" name="player_stats[{{ $player->id }}][1][blk]" min="0">
                            </div>
                            <div style="display: flex; flex-direction: column;">
                                <span>PF</span>
                                <input type="number" name="player_stats[{{ $player->id }}][1][pf]" min="0">
                            </div>
                            <div style="display: flex; flex-direction: column;">
                                <span>TO</span>
                                <input type="number" name="player_stats[{{ $player->id }}][1][to]" min="0">
                            </div>
                        </div>
                    </div>
                </div>
